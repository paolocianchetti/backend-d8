...
const PostsCard = ({ title, price, author, rate, category, cover }) => {
    return (
        <div className="rounded-md shadow-md sm:w-96 dark:bg-gray-900 dark:text-gray-100">
            <div className="flex items-center justify-between p-3">
                <div className="flex items-center space-x-2">
                    ...
                    <div className="-space-y-1">
                        <h2 className="text-sm font-semibold leadi">{author}</h2>
                        <span className="inline-block text-xs leadi dark:text-gray-400">{category}</span>
                    </div>
                </div>
            ...
            <img src={cover} alt="" className="object-cover object-center w-full h-72 dark:bg-gray-500" />
            <div className="p-3">
